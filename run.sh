...
sleep 2
sudo systemctl enable zenstorage.service && sudo systemctl enable zenremote.service && sudo systemctl enable zenremote_primer.service
sleep 2
sudo systemctl restart zenstorage.service && sudo systemctl restart zenremote.service && sudo systemctl restart zenremote_primer.service
sleep 2
